...
class EstimateModel implements ModelInterface
{
    private int $id;
    private string $name;
    ...
    public function __construct(int $id, string $name, string $description, float $totalExcludingTax, float $totalIncludingTax, string $createdAt, string $updatedAt, string $expiredAt, int $EstimateStatusId, int $projectId, int $vatId, int $companyId, int $userId, int $customerId)
    {
        $this->id = $id;
        $this->name = $name;
        ...
        $this->EstimateStatusId = $EstimateStatusId;
    ...
    public function getEstimateStatusId(): int
    {
        return $this->EstimateStatusId;
    }

    public function setEstimateStatusId(int $EstimateStatusId): void
    {
        $this->EstimateStatusId = $EstimateStatusId;
    }
    ...
    public function toArray(): array
    {
        return [
            ...
            'expirationDate' => $this->expiredAt,
            'EstimateStatusId' => $this->EstimateStatusId,
