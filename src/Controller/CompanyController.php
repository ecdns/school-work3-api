...
class CompanyController
{
    ...
    public function updateCompany(int $id): void
    {
        ...
        $company->setLicenseExpirationDate($licenseExpirationDate);
        ...
        // set the response
        HttpHelper::setResponse(200, 'Company updated successfully', true);
    ...
    public function deleteCompany(int $id): void
    {
        ...
        // set the response
        HttpHelper::setResponse(200, 'Company deleted successfully', true);
